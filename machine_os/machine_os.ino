...
class ToolChangePoint {
  ...
  // автоматически подводим инструмент к датчику касания инструмента (только по X и Y)
    // опускает новый инструмент до момента срабатывания датчика касания инструмента
    // вычисляем разницу длины предыдущего и нынешнего инструмента
    // сравниваем с точкой начала координат и если инструмент слишком длинный, ведем шпиндель в самый верх и
    //  пишем в com port, что инструмент слишком длинный и нужно поставить инструмент покороче
